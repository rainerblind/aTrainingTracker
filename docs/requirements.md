...
| **REQ-PRO-003** | Prevent distance accumulation while paused. | Ensure workout statistics only reflect active movement. | `MyAccumulatorSensor.java`, `ANTBikeSpeedDevice.java`, `BTLEBikeDevice.java` | `TST-UNT-008` | Verified |
