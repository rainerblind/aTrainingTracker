...
| **REQ-UI-043** | Composable Edit Dialogs. | Device configuration and editing SHALL be handled via Composable dialogs, replacing the legacy XML-based EditDeviceFragment hierarchy. | `EditDeviceDialog.kt` | `TST-UI-043` | Verified |
