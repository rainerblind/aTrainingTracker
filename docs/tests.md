...
| **TST-UI-044** | **Device Item Visual Consistency** | `REQ-UI-042` | Compare DeviceItem against SegmentItem. Verify exactly 32dp icons, titleLarge typography, right-aligned switch, and horizontal divider separation. | Verified |
