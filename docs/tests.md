...
| **TST-SET-029** | **Unclustered Tab Verification** | `REQ-SET-039` | 1. Navigate to Favorite Tracks. 2. Open 'Offen' tab. 3. Tap a workout. | 1. Workouts with clusterId=-1 are visible. 2. Selection dialog opens and reassignment works correctly. | Verified |
| **TST-SET-030** | **Locale-Aware Distance Input** | `REQ-SET-039` | 1. Set device locale to German. 2. Open 'Add Workout Cluster' flow. 3. Enter '5,5' in the distance field. | 1. The 'Save' button becomes enabled. 2. Saving the cluster correctly parses '5,5' as 5.5 units (km or miles). | Proposed |
