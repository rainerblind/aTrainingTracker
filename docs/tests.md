...
| **TST-SET-032** | **Markers in Previews** | `REQ-SET-042` | 1. Open the Workout History list. 2. Open the Routes list. 3. Observe the mini-maps. | 1. Workout previews show Start (Green), End (Red), and Apex (Blue) markers. 2. Route previews show ONLY Start and End markers. | Proposed |
