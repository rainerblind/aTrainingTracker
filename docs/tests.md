...
| **TST-SET-002** | **Regular Tracks Heatmap** | `REQ-SET-009` | 1. Navigate to \"Workout Clusters\" drawer. 2. Select a recurring path. | 1. A map SHALL open showing a heatmap of all associated workouts. 2. Start, Stop, and Apex markers SHALL be visible as clear pins. | Verified |
...
| **TST-SET-006** | **Auto-Dismiss Tuning** | `REQ-SET-014` | 1. Open Tuning screen. 2. Tap \"Recalculate All Clusters\". 3. Wait for completion. | The UI SHALL automatically navigate back to the Regular Tracks list view upon completion. | Verified |
