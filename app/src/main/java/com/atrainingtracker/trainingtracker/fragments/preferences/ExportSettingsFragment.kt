...
/**
 * Fragment to manage Export settings, promoted to a top-level navigation target.
 */
class ExportSettingsFragment : PreferenceFragmentCompat() {

    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        setPreferencesFromResource(R.xml.prefs_export, null)
    }
    ...
    companion object {
        const val TAG: String = "ExportSettingsFragment"

        @JvmStatic
        fun newInstance(): ExportSettingsFragment = ExportSettingsFragment()
    }
}
