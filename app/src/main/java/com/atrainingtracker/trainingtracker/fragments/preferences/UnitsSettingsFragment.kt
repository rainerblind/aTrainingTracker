...
class UnitsSettingsFragment : PreferenceFragmentCompat() {

    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        setPreferencesFromResource(R.xml.prefs_units, null)
    }
    ...
    companion object {
        const val TAG: String = "UnitsSettingsFragment"

        @JvmStatic
        fun newInstance(): UnitsSettingsFragment = UnitsSettingsFragment()
    }
}
