...
import com.atrainingtracker.banalservice.fragments.ControlSportTypeFragmentClassic;
import com.atrainingtracker.banalservice.fragments.TrackingModeFragmentClassic;
...
@Deprecated
public class ControlTrackingFragmentClassic extends BaseTrackingFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (childFragmentManager.findFragmentById(R.id.tracking_mode_container) == null) {
            TrackingModeFragmentClassic trackingModeFragment = new TrackingModeFragmentClassic();
        ...
        if (childFragmentManager.findFragmentById(R.id.ctl_control_sport_type_container) == null) {
            ControlSportTypeFragmentClassic controlSportTypeFragment = new ControlSportTypeFragmentClassic();
            childFragmentManager.beginTransaction()
