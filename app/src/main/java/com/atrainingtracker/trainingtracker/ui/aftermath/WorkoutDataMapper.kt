...
class WorkoutDataMapper(
    ...
    fun fromCursor(cursor: Cursor): WorkoutData {
        ...
        return WorkoutData(
            ...
            startAltitude = workoutSummariesDatabaseManager.getExtremaValue(workoutId, SensorType.ALTITUDE, ExtremaType.START),
            endAltitude = workoutSummariesDatabaseManager.getExtremaValue(workoutId, SensorType.ALTITUDE, ExtremaType.END),
    ...
    fun fromCursor(cursor: Cursor, batch: BatchMetadata): WorkoutData {
        ...
        return WorkoutData(
            ...
            startAltitude = getBatchVal(SensorType.ALTITUDE, ExtremaType.START),
            endAltitude = getBatchVal(SensorType.ALTITUDE, ExtremaType.END),
