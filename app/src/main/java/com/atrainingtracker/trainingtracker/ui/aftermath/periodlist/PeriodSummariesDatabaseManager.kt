...
class PeriodSummariesDatabaseManager private constructor(context: Context) {
    ...
    init {
        ...
        listOf("PeriodSummaries_v4.db", "PeriodSummaries_v4.db-shm", "PeriodSummaries_v4.db-wal",
               ...
               "PeriodSummaries_v19.db", "PeriodSummaries_v19.db-shm", "PeriodSummaries_v19.db-wal",
    ...
    private fun mapCursorToPeriod(cursor: Cursor, sportStats: Map<BSportType, SportStats>): PeriodSummary {
        return PeriodSummary(
            ...
            minLat = if (cursor.isNull(cursor.getColumnIndexOrThrow(PeriodSummariesContract.COLUMN_BOUND_MIN_LAT))) 90.0 else cursor.getDouble(cursor.getColumnIndexOrThrow(PeriodSummariesContract.COLUMN_BOUND_MIN_LAT)),
            minLng = if (cursor.isNull(cursor.getColumnIndexOrThrow(PeriodSummariesContract.COLUMN_BOUND_MIN_LNG))) 180.0 else cursor.getDouble(cursor.getColumnIndexOrThrow(PeriodSummariesContract.COLUMN_BOUND_MIN_LNG)),
            maxLat = if (cursor.isNull(cursor.getColumnIndexOrThrow(PeriodSummariesContract.COLUMN_BOUND_MAX_LAT))) -90.0 else cursor.getDouble(cursor.getColumnIndexOrThrow(PeriodSummariesContract.COLUMN_BOUND_MAX_LAT)),
            maxLng = if (cursor.isNull(cursor.getColumnIndexOrThrow(PeriodSummariesContract.COLUMN_BOUND_MAX_LNG))) -180.0 else cursor.getDouble(cursor.getColumnIndexOrThrow(PeriodSummariesContract.COLUMN_BOUND_MAX_LNG)),
