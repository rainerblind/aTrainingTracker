...
/**
 * A draggable fast-scroll bar for LazyColumn housed in core design package (REQ-UI-148, ATT-939).
 *
 * @param state The [LazyListState] being scrolled.
 * @param modifier Modifier applied to the scrollbar layout.
 * @param thumbColor Tint color applied to the thumb indicator.
 * @param trackColor Background color of the scroll track line.
 */
@Composable
fun FastScrollbar(
    state: LazyListState,
