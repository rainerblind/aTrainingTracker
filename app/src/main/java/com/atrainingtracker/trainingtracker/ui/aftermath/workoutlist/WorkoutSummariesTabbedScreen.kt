...
/**
 * Top-level Composable for the Workout Summaries tabbed interface (REQ-UI-159).
 */
@Composable
fun WorkoutSummariesTabbedScreen(
    viewModel: WorkoutSummariesViewModel = viewModel(),
    ...
    LaunchedEffect(workouts) {
        val targetFileName = activity?.intent?.getStringExtra(ExportStatusChangedBroadcaster.EXTRA_FILE_BASE_NAME)
        ...
        Box(modifier = Modifier.padding(paddingValues)) {
            ...
            if (selectedWorkoutIdForEdit != null) {
                ...
                val editViewModel: EditWorkoutViewModel = viewModel(
                    ...
                    factory = EditWorkoutViewModelFactory(app, selectedWorkoutIdForEdit!!)
                )
