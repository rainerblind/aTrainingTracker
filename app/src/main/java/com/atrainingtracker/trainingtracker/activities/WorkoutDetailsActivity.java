...
// import com.atrainingtracker.trainingtracker.ui.aftermath.editworkout.EditWorkoutFragment;
...
public class WorkoutDetailsActivity extends AppCompatActivity
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        } else if (!WorkoutSummariesDatabaseManager.getBoolean(this, mWorkoutID, WorkoutSummaries.EXTREMA_VALUES_CALCULATED)) {  // extrema values are not yet calculated
