...
//                break;
    ...
    public void onBackPressed() {
        // TODO: optimize: when showing "deeper fragments", we only want to go back one step and not completely to the start_tracking framgent
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.itemDeleteOldWorkouts:  // TODO: move to somewhere else?  automatially??
