...
//	protected int           mSoftwareRevision;
    ...
    protected void onDeviceStateChangeHandler(DeviceState newDeviceState) {
        ...
        if (isSearching() && newDeviceState != DeviceState.SEARCHING) {
            ...
            notifyStopSearching(success);  // ARGH might be called several times?
...
//    {
//    	myLog("onResultReceivedHander: resultCode=" + resultCode + ", initialDeviceStat=" + initialDeviceState);
//    	
//    	switch(resultCode)
//    	{
...
//    		
//    	case OTHER_FAILURE:
//    		myLog("onResultReceivedHander: other failure");
//    		break;
//    		
//    	case DEPENDENCY_NOT_INSTALLED:
//    		myLog("onResultReceivedHander: dependency not installed");
//    		dependencyNotInstalled();    		
//    		break;
//    		
//    	case USER_CANCELLED:
//    		myLog("onResultReceiverHander: user cancelled");
//    		break;
//    		
//    	default:
...
//            }});
    ...
    final protected void onNewPluginPccFound(AntPluginPcc antPluginPcc) {
        ...
        myLog("AntPlubinPcc class name: " + antPluginPcc.getClass().getName());
